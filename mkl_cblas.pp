...
function cblas_dcabs1(const z:pointer):double;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_scabs1(const c:pointer):single;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_sdot(const N:MKL_INT; const X:Psingle; const incX:MKL_INT; const Y:Psingle; const incY:MKL_INT):single;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_sdoti(const N:MKL_INT; const X:Psingle; const indx:PMKL_INT; const Y:Psingle):single;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_ddot(const N:MKL_INT; const X:Pdouble; const incX:MKL_INT; const Y:Pdouble; const incY:MKL_INT):double;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_ddoti(const N:MKL_INT; const X:Pdouble; const indx:PMKL_INT; const Y:Pdouble):double;_CALLING external {$ifdef libmkl} libmkl{$endif};
function cblas_dsdot(const N:MKL_INT; const X:Psingle; const incX:MKL_INT; const Y:Psingle; const incY:MKL_INT):double;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_sdsdot(const N:MKL_INT; const sb:single; const X:Psingle; const incX:MKL_INT; const Y:Psingle; const
           incY:MKL_INT):single;_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_cdotu_sub(const N:MKL_INT; const X:pointer; const incX:MKL_INT; const Y:pointer; const incY:MKL_INT; const
            dotu:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_cdotui_sub(const N:MKL_INT; const X:pointer; const indx:PMKL_INT; const Y:pointer; const dotui:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_cdotc_sub(const N:MKL_INT; const X:pointer; const incX:MKL_INT; const Y:pointer; const incY:MKL_INT; const
            dotc:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_cdotci_sub(const N:MKL_INT; const X:pointer; const indx:PMKL_INT; const Y:pointer; const dotui:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_zdotu_sub(const N:MKL_INT; const X:pointer; const incX:MKL_INT; const Y:pointer; const incY:MKL_INT; const
            dotu:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_zdotui_sub(const N:MKL_INT; const X:pointer; const indx:PMKL_INT; const Y:pointer; const dotui:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_zdotc_sub(const N:MKL_INT; const X:pointer; const incX:MKL_INT; const Y:pointer; const incY:MKL_INT; const
            dotc:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_zdotci_sub(const N:MKL_INT; const X:pointer; const indx:PMKL_INT; const Y:pointer; const dotui:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};

{
 * Functions having prefixes S D SC DZ
  }
function cblas_snrm2(const N:MKL_INT; const X:Psingle; const incX:MKL_INT):single;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_sasum(const N:MKL_INT; const X:Psingle; const incX:MKL_INT):single;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_dnrm2(const N:MKL_INT; const X:Pdouble; const incX:MKL_INT):double;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_dasum(const N:MKL_INT; const X:Pdouble; const incX:MKL_INT):double;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_scnrm2(const N:MKL_INT; const X:pointer; const incX:MKL_INT):single;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_scasum(const N:MKL_INT; const X:pointer; const incX:MKL_INT):single;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_dznrm2(const N:MKL_INT; const X:pointer; const incX:MKL_INT):double;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_dzasum(const N:MKL_INT; const X:pointer; const incX:MKL_INT):double;_CALLING external {$ifdef libmkl} libmkl{$endif};

{
 * Functions having standard 4 prefixes (const S D C Z)
  }

function cblas_isamax(const N:MKL_INT; const X:Psingle; const incX:MKL_INT):TCBLAS_INDEX;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_idamax(const N:MKL_INT; const X:Pdouble; const incX:MKL_INT):TCBLAS_INDEX;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_icamax(const N:MKL_INT; const X:pointer; const incX:MKL_INT):TCBLAS_INDEX;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_izamax(const N:MKL_INT; const X:pointer; const incX:MKL_INT):TCBLAS_INDEX;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_isamin(const N:MKL_INT; const X:Psingle; const incX:MKL_INT):TCBLAS_INDEX;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_idamin(const N:MKL_INT; const X:Pdouble; const incX:MKL_INT):TCBLAS_INDEX;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_icamin(const N:MKL_INT; const X:pointer; const incX:MKL_INT):TCBLAS_INDEX;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_izamin(const N:MKL_INT; const X:pointer; const incX:MKL_INT):TCBLAS_INDEX;_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_sswap(const N:MKL_INT; const X:Psingle; const incX:MKL_INT; const Y:Psingle; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_scopy(const N:MKL_INT; const X:Psingle; const incX:MKL_INT; const Y:Psingle; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_saxpy(const N:MKL_INT; const alpha:single; const X:Psingle; const incX:MKL_INT; const Y:Psingle; const
            incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_saxpby(const N:MKL_INT; const alpha:single; const X:Psingle; const incX:MKL_INT; const beta:single; const
            Y:Psingle; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_saxpyi(const N:MKL_INT; const alpha:single; const X:Psingle; const indx:PMKL_INT; const Y:Psingle);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_sgthr(const N:MKL_INT; const Y:Psingle; const X:Psingle; const indx:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_sgthrz(const N:MKL_INT; const Y:Psingle; const X:Psingle; const indx:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_ssctr(const N:MKL_INT; const X:Psingle; const indx:PMKL_INT; const Y:Psingle);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_srotg(const a:Psingle; const b:Psingle; const c:Psingle; const s:Psingle);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_dswap(const N:MKL_INT; const X:Pdouble; const incX:MKL_INT; const Y:Pdouble; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_dcopy(const N:MKL_INT; const X:Pdouble; const incX:MKL_INT; const Y:Pdouble; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_daxpby(const N:MKL_INT; const alpha:double; const X:Pdouble; const incX:MKL_INT; const beta:double; const
            Y:Pdouble; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_daxpyi(const N:MKL_INT; const alpha:double; const X:Pdouble; const indx:PMKL_INT; const Y:Pdouble);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_dgthr(const N:MKL_INT; const Y:Pdouble; const X:Pdouble; const indx:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_dgthrz(const N:MKL_INT; const Y:Pdouble; const X:Pdouble; const indx:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_dsctr(const N:MKL_INT; const X:Pdouble; const indx:PMKL_INT; const Y:Pdouble);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_drotg(const a:Pdouble; const b:Pdouble; const c:Pdouble; const s:Pdouble);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_cswap(const N:MKL_INT; const X:pointer; const incX:MKL_INT; const Y:pointer; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_ccopy(const N:MKL_INT; const X:pointer; const incX:MKL_INT; const Y:pointer; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_caxpby(const N:MKL_INT; const alpha:pointer; const X:pointer; const incX:MKL_INT; const beta:pointer; const
            Y:pointer; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_caxpyi(const N:MKL_INT; const alpha:pointer; const X:pointer; const indx:PMKL_INT; const Y:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_cgthr(const N:MKL_INT; const Y:pointer; const X:pointer; const indx:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_cgthrz(const N:MKL_INT; const Y:pointer; const X:pointer; const indx:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_csctr(const N:MKL_INT; const X:pointer; const indx:PMKL_INT; const Y:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_crotg(const a:pointer; const b:pointer; const c:Psingle; const s:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_zswap(const N:MKL_INT; const X:pointer; const incX:MKL_INT; const Y:pointer; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_zcopy(const N:MKL_INT; const X:pointer; const incX:MKL_INT; const Y:pointer; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_zaxpyi(const N:MKL_INT; const alpha:pointer; const X:pointer; const indx:PMKL_INT; const Y:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_zgthr(const N:MKL_INT; const Y:pointer; const X:pointer; const indx:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_zgthrz(const N:MKL_INT; const Y:pointer; const X:pointer; const indx:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_zsctr(const N:MKL_INT; const X:pointer; const indx:PMKL_INT; const Y:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_zrotg(const a:pointer; const b:pointer; const c:Pdouble; const s:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};
{
 * Routines with S and D prefix only
  }
procedure cblas_srotmg(const d1:Psingle; const d2:Psingle; const b1:Psingle; const b2:single; const P:Psingle);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_srot(const N:MKL_INT; const X:Psingle; const incX:MKL_INT; const Y:Psingle; const incY:MKL_INT; const
            c:single; const s:single);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_sroti(const N:MKL_INT; const X:Psingle; const indx:PMKL_INT; const Y:Psingle; const c:single; const
            s:single);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_srotm(const N:MKL_INT; const X:Psingle; const incX:MKL_INT; const Y:Psingle; const incY:MKL_INT; const
            P:Psingle);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_drotmg(const d1:Pdouble; const d2:Pdouble; const b1:Pdouble; const b2:double; const P:Pdouble);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_drot(const N:MKL_INT; const X:Pdouble; const incX:MKL_INT; const Y:Pdouble; const incY:MKL_INT; const
            c:double; const s:double);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_drotm(const N:MKL_INT; const X:Pdouble; const incX:MKL_INT; const Y:Pdouble; const incY:MKL_INT; const
            P:Pdouble);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_droti(const N:MKL_INT; const X:Pdouble; const indx:PMKL_INT; const Y:Pdouble; const c:double; const
            s:double);_CALLING external {$ifdef libmkl} libmkl{$endif};
{
...
procedure cblas_sscal(const N:MKL_INT; const alpha:single; const X:Psingle; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_dscal(const N:MKL_INT; const alpha:double; const X:Pdouble; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_cscal(const N:MKL_INT; const alpha:pointer; const X:pointer; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_zscal(const N:MKL_INT; const alpha:pointer; const X:pointer; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_csscal(const N:MKL_INT; const alpha:single; const X:pointer; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_zdscal(const N:MKL_INT; const alpha:double; const X:pointer; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
{
 * ===========================================================================
...
procedure cblas_sgbmv(const Layout:TCBLAS_LAYOUT; const TransA:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const KL:MKL_INT; const
            ...
            incX:MKL_INT; const beta:single; const Y:Psingle; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_strmv(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const N:MKL_INT; const
            A:Psingle; const lda:MKL_INT; const X:Psingle; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_stbmv(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const N:MKL_INT; const
            K:MKL_INT; const A:Psingle; const lda:MKL_INT; const X:Psingle; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_stpmv(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const N:MKL_INT; const
            Ap:Psingle; const X:Psingle; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dgbmv(const Layout:TCBLAS_LAYOUT; const TransA:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const KL:MKL_INT; const
            ...
            incX:MKL_INT; const beta:double; const Y:Pdouble; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dtrmv(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const N:MKL_INT; const
            A:Pdouble; const lda:MKL_INT; const X:Pdouble; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dtbmv(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const N:MKL_INT; const
            K:MKL_INT; const A:Pdouble; const lda:MKL_INT; const X:Pdouble; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dtpmv(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const N:MKL_INT; const
            Ap:Pdouble; const X:Pdouble; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_cgbmv(const Layout:TCBLAS_LAYOUT; const TransA:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const KL:MKL_INT; const
            ...
            incX:MKL_INT; const beta:pointer; const Y:pointer; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_ctrmv(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const N:MKL_INT; const
            A:pointer; const lda:MKL_INT; const X:pointer; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_ctbmv(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const N:MKL_INT; const
            K:MKL_INT; const A:pointer; const lda:MKL_INT; const X:pointer; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_ctpmv(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const N:MKL_INT; const
            Ap:pointer; const X:pointer; const incX:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_sspmv(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const N:MKL_INT; const alpha:single; const Ap:Psingle; const
            X:Psingle; const incX:MKL_INT; const beta:single; const Y:Psingle; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_sger(const Layout:TCBLAS_LAYOUT; const M:MKL_INT; const N:MKL_INT; const alpha:single; const X:Psingle; const
            incX:MKL_INT; const Y:Psingle; const incY:MKL_INT; const A:Psingle; const lda:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_ssyr(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const N:MKL_INT; const alpha:single; const X:Psingle; const
            incX:MKL_INT; const A:Psingle; const lda:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_sspr(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const N:MKL_INT; const alpha:single; const X:Psingle; const
            incX:MKL_INT; const Ap:Psingle);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_sspr2(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const N:MKL_INT; const alpha:single; const X:Psingle; const
            incX:MKL_INT; const Y:Psingle; const incY:MKL_INT; const A:Psingle);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dspmv(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const N:MKL_INT; const alpha:double; const Ap:Pdouble; const
            X:Pdouble; const incX:MKL_INT; const beta:double; const Y:Pdouble; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

procedure cblas_dger(const Layout:TCBLAS_LAYOUT; const M:MKL_INT; const N:MKL_INT; const alpha:double; const X:Pdouble; const
            incX:MKL_INT; const Y:Pdouble; const incY:MKL_INT; const A:Pdouble; const lda:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dsyr(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const N:MKL_INT; const alpha:double; const X:Pdouble; const
            incX:MKL_INT; const A:Pdouble; const lda:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dspr(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const N:MKL_INT; const alpha:double; const X:Pdouble; const
            incX:MKL_INT; const Ap:Pdouble);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dspr2(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const N:MKL_INT; const alpha:double; const X:Pdouble; const
            incX:MKL_INT; const Y:Pdouble; const incY:MKL_INT; const A:Pdouble);_CALLING external {$ifdef libmkl} libmkl{$endif};
{
...
procedure cblas_chpmv(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const N:MKL_INT; const alpha:pointer; const Ap:pointer; const
            X:pointer; const incX:MKL_INT; const beta:pointer; const Y:pointer; const incY:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_cgeru(const Layout:TCBLAS_LAYOUT; const M:MKL_INT; const N:MKL_INT; const alpha:pointer; const X:pointer; const
            incX:MKL_INT; const Y:pointer; const incY:MKL_INT; const A:pointer; const lda:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_cher(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const N:MKL_INT; const alpha:single; const X:pointer; const
            incX:MKL_INT; const A:pointer; const lda:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_chpr(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const N:MKL_INT; const alpha:single; const X:pointer; const
            incX:MKL_INT; const A:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_chpr2(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const N:MKL_INT; const alpha:pointer; const X:pointer; const
            incX:MKL_INT; const Y:pointer; const incY:MKL_INT; const Ap:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_sgemm(const Layout:TCBLAS_LAYOUT; const TransA:TCBLAS_TRANSPOSE; const TransB:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const
            ...
            ldb:MKL_INT; const beta:single; const C:Psingle; const ldc:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_sgemm_batch_strided(const Layout:TCBLAS_LAYOUT; const TransA:TCBLAS_TRANSPOSE; const TransB:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const
            ...
            ldc:MKL_INT; const stridec:MKL_INT; const batch_size:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_ssymm(const Layout:TCBLAS_LAYOUT; const Side:TCBLAS_SIDE; const Uplo:TCBLAS_UPLO; const M:MKL_INT; const N:MKL_INT; const
            ...
            beta:single; const C:Psingle; const ldc:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_ssyrk(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const Trans:TCBLAS_TRANSPOSE; const N:MKL_INT; const K:MKL_INT; const
            ...
            ldc:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_ssyrk_batch_strided(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const Trans:TCBLAS_TRANSPOSE; const N:MKL_INT; const K:MKL_INT; const
            ...
            C:Psingle; const ldc:MKL_INT; const stridec:MKL_INT; const batch_size:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_ssyrk_batch(const Layout:TCBLAS_LAYOUT; const Uplo_array:PCBLAS_UPLO; const Trans_array:PCBLAS_TRANSPOSE; const N_array:PMKL_INT; const K_array:PMKL_INT; const
            ...
            ldc_array:PMKL_INT; const group_count:MKL_INT; const group_size:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_strmm(const Layout:TCBLAS_LAYOUT; const Side:TCBLAS_SIDE; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const
            ...
            B:Psingle; const ldb:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_strsm_batch(const Layout:TCBLAS_LAYOUT; const Side_Array:PCBLAS_SIDE; const Uplo_Array:PCBLAS_UPLO; const TransA_Array:PCBLAS_TRANSPOSE; const Diag_Array:PCBLAS_DIAG; const
            ...
            B_Array:PPsingle; const ldb_Array:PMKL_INT; const group_count:MKL_INT; const group_size:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_strsm_batch_strided(const Layout:TCBLAS_LAYOUT; const Side:TCBLAS_SIDE; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const
            M:MKL_INT; const N:MKL_INT; const alpha:single; const A:Psingle; const lda:MKL_INT; const
            stridea:MKL_INT; const B:Psingle; const ldb:MKL_INT; const strideb:MKL_INT; const batch_size:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dgemm(const Layout:TCBLAS_LAYOUT; const TransA:TCBLAS_TRANSPOSE; const TransB:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const
            ...
            ldb:MKL_INT; const beta:double; const C:Pdouble; const ldc:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dsymm(const Layout:TCBLAS_LAYOUT; const Side:TCBLAS_SIDE; const Uplo:TCBLAS_UPLO; const M:MKL_INT; const N:MKL_INT; const
            ...
            beta:double; const C:Pdouble; const ldc:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dsyrk_batch_strided(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const Trans:TCBLAS_TRANSPOSE; const N:MKL_INT; const K:MKL_INT; const
            ...
            C:Pdouble; const ldc:MKL_INT; const stridec:MKL_INT; const batch_size:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dtrmm(const Layout:TCBLAS_LAYOUT; const Side:TCBLAS_SIDE; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const
            ...
            B:Pdouble; const ldb:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dtrsm_batch(const Layout:TCBLAS_LAYOUT; const Side_Array:PCBLAS_SIDE; const Uplo_Array:PCBLAS_UPLO; const Transa_Array:PCBLAS_TRANSPOSE; const Diag_Array:PCBLAS_DIAG; const
            ...
            B_Array:PPdouble; const ldb_Array:PMKL_INT; const group_count:MKL_INT; const group_size:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dtrsm_batch_strided(const Layout:TCBLAS_LAYOUT; const Side:TCBLAS_SIDE; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const
            M:MKL_INT; const N:MKL_INT; const alpha:double; const A:Pdouble; const lda:MKL_INT; const
            stridea:MKL_INT; const B:Pdouble; const ldb:MKL_INT; const strideb:MKL_INT; const batch_size:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_cgemm(const Layout:TCBLAS_LAYOUT; const TransA:TCBLAS_TRANSPOSE; const TransB:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const
            ...
            ldb:MKL_INT; const beta:pointer; const C:pointer; const ldc:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_csymm(const Layout:TCBLAS_LAYOUT; const Side:TCBLAS_SIDE; const Uplo:TCBLAS_UPLO; const M:MKL_INT; const N:MKL_INT; const
            ...
            beta:pointer; const C:pointer; const ldc:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_csyrk_batch_strided(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const Trans:TCBLAS_TRANSPOSE; const N:MKL_INT; const K:MKL_INT; const
            ...
            C:pointer; const ldc:MKL_INT; const stridec:MKL_INT; const batch_size:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_ctrmm(const Layout:TCBLAS_LAYOUT; const Side:TCBLAS_SIDE; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const
            ...
            B:pointer; const ldb:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_ctrsm_batch(const Layout:TCBLAS_LAYOUT; const Side_Array:PCBLAS_SIDE; const Uplo_Array:PCBLAS_UPLO; const Transa_Array:PCBLAS_TRANSPOSE; const Diag_Array:PCBLAS_DIAG; const
            ...
            B_Array:Ppointer; const ldb_Array:PMKL_INT; const group_count:MKL_INT; const group_size:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_ctrsm_batch_strided(const Layout:TCBLAS_LAYOUT; const Side:TCBLAS_SIDE; const Uplo:TCBLAS_UPLO; const TransA:TCBLAS_TRANSPOSE; const Diag:TCBLAS_DIAG; const
            M:MKL_INT; const N:MKL_INT; const alpha:pointer; const A:pointer; const lda:MKL_INT; const
            stridea:MKL_INT; const B:pointer; const ldb:MKL_INT; const strideb:MKL_INT; const batch_size:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_cher2k(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const Trans:TCBLAS_TRANSPOSE; const N:MKL_INT; const K:MKL_INT; const
            alpha:pointer; const A:pointer; const lda:MKL_INT; const B:pointer; const ldb:MKL_INT; const
            beta:single; const C:pointer; const ldc:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_zher2k(const Layout:TCBLAS_LAYOUT; const Uplo:TCBLAS_UPLO; const Trans:TCBLAS_TRANSPOSE; const N:MKL_INT; const K:MKL_INT; const
            alpha:pointer; const A:pointer; const lda:MKL_INT; const B:pointer; const ldb:MKL_INT; const
            beta:double; const C:pointer; const ldc:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
{
 * Routines with prefixes S and D only
  }
function cblas_sgemm_pack_get_size(const identifier:TCBLAS_IDENTIFIER; const M:MKL_INT; const N:MKL_INT; const K:MKL_INT):size_t;_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_sgemm_pack(const Layout:TCBLAS_LAYOUT; const identifier:TCBLAS_IDENTIFIER; const Trans:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const
            K:MKL_INT; const alpha:single; const src:Psingle; const ld:MKL_INT; const dest:Psingle);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
function cblas_dgemm_pack_get_size(const identifier:TCBLAS_IDENTIFIER; const M:MKL_INT; const N:MKL_INT; const K:MKL_INT):size_t;_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dgemm_pack(const Layout:TCBLAS_LAYOUT; const identifier:TCBLAS_IDENTIFIER; const Trans:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const
            K:MKL_INT; const alpha:double; const src:Pdouble; const ld:MKL_INT; const dest:Pdouble);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_hgemm(const Layout:TCBLAS_LAYOUT; const TransA:TCBLAS_TRANSPOSE; const TransB:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const
            ...
            ldb:MKL_INT; const beta:TMKL_F16; const C:PMKL_F16; const ldc:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_hgemm_pack_get_size(const identifier:TCBLAS_IDENTIFIER; const M:MKL_INT; const N:MKL_INT; const K:MKL_INT):size_t;_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_hgemm_pack(const Layout:TCBLAS_LAYOUT; const identifier:TCBLAS_IDENTIFIER; const Trans:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const
            K:MKL_INT; const alpha:TMKL_F16; const src:PMKL_F16; const ld:MKL_INT; const dest:PMKL_F16);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_hgemm_compute(const Layout:TCBLAS_LAYOUT; const TransA:MKL_INT; const TransB:MKL_INT; const M:MKL_INT; const N:MKL_INT; const
            ...
            beta:TMKL_F16; const C:PMKL_F16; const ldc:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
{
 * Integer Routines
  }
...
procedure cblas_gemm_s16s16s32(const Layout:TCBLAS_LAYOUT; const TransA:TCBLAS_TRANSPOSE; const TransB:TCBLAS_TRANSPOSE; const OffsetC:TCBLAS_OFFSET; const M:MKL_INT; const
            ...
            C:PMKL_INT32; const ldc:MKL_INT; const cb:PMKL_INT32);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
function cblas_gemm_s8u8s32_pack_get_size(const identifier:TCBLAS_IDENTIFIER; const M:MKL_INT; const N:MKL_INT; const K:MKL_INT):size_t;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_gemm_s16s16s32_pack_get_size(const identifier:TCBLAS_IDENTIFIER; const M:MKL_INT; const N:MKL_INT; const K:MKL_INT):size_t;_CALLING external {$ifdef libmkl} libmkl{$endif};

function cblas_gemm_bf16bf16f32_pack_get_size(const identifier:TCBLAS_IDENTIFIER; const M:MKL_INT; const N:MKL_INT; const K:MKL_INT):size_t;_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_gemm_s8u8s32_pack(const Layout:TCBLAS_LAYOUT; const identifier:TCBLAS_IDENTIFIER; const Trans:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const
            K:MKL_INT; const src:pointer; const ld:MKL_INT; const dest:pointer);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_gemm_s16s16s32_pack(const Layout:TCBLAS_LAYOUT; const identifier:TCBLAS_IDENTIFIER; const Trans:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const
            K:MKL_INT; const src:PMKL_INT16; const ld:MKL_INT; const dest:PMKL_INT16);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_gemm_bf16bf16f32_pack(const Layout:TCBLAS_LAYOUT; const identifier:TCBLAS_IDENTIFIER; const Trans:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const
            K:MKL_INT; const src:PMKL_BF16; const ld:MKL_INT; const dest:PMKL_BF16);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_gemm_s8u8s32_compute(const Layout:TCBLAS_LAYOUT; const TransA:MKL_INT; const TransB:MKL_INT; const offsetc:TCBLAS_OFFSET; const M:MKL_INT; const
            N:MKL_INT; const K:MKL_INT; const alpha:single; const A:pointer; const lda:MKL_INT; const
            ao:MKL_INT8; const B:pointer; const ldb:MKL_INT; const bo:MKL_INT8; const beta:single; const
            C:PMKL_INT32; const ldc:MKL_INT; const co:PMKL_INT32);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_saxpy_batch(const n:PMKL_INT; const alpha:Psingle; const x:PPsingle; const incx:PMKL_INT; const y:PPsingle; const
            incy:PMKL_INT; const group_count:MKL_INT; const group_size:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_saxpy_batch_strided(const N:MKL_INT; const alpha:single; const X:Psingle; const incX:MKL_INT; const stridex:MKL_INT; const
            Y:Psingle; const incY:MKL_INT; const stridey:MKL_INT; const batch_size:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_daxpy_batch_strided(const N:MKL_INT; const alpha:double; const X:Pdouble; const incX:MKL_INT; const stridex:MKL_INT; const
            Y:Pdouble; const incY:MKL_INT; const stridey:MKL_INT; const batch_size:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_caxpy_batch_strided(const N:MKL_INT; const alpha:pointer; const X:pointer; const incX:MKL_INT; const stridex:MKL_INT; const
            Y:pointer; const incY:MKL_INT; const stridey:MKL_INT; const batch_size:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_scopy_batch(const n:PMKL_INT; const x:PPsingle; const incx:PMKL_INT; const y:PPsingle; const incy:PMKL_INT; const
            group_count:MKL_INT; const group_size:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_scopy_batch_strided(const N:MKL_INT; const X:Psingle; const incX:MKL_INT; const stridex:MKL_INT; const Y:Psingle; const
            incY:MKL_INT; const stridey:MKL_INT; const batch_size:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_sgemv_batch(const Layout:TCBLAS_LAYOUT; const TransA:PCBLAS_TRANSPOSE; const M:PMKL_INT; const N:PMKL_INT; const alpha:Psingle; const
            ...
            Y:PPsingle; const incY:PMKL_INT; const group_count:MKL_INT; const group_size:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_sgemv_batch_strided(const Layout:TCBLAS_LAYOUT; const TransA:TCBLAS_TRANSPOSE; const M:MKL_INT; const N:MKL_INT; const alpha:single; const
            ...
            batch_size:MKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_dgemv_batch(const Layout:TCBLAS_LAYOUT; const TransA:PCBLAS_TRANSPOSE; const M:PMKL_INT; const N:PMKL_INT; const alpha:Pdouble; const
            ...
            Y:PPdouble; const incY:PMKL_INT; const group_count:MKL_INT; const group_size:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
...
procedure cblas_cgemv_batch(const Layout:TCBLAS_LAYOUT; const TransA:PCBLAS_TRANSPOSE; const M:PMKL_INT; const N:PMKL_INT; const alpha:pointer; const
            ...
            Y:Ppointer; const incY:PMKL_INT; const group_count:MKL_INT; const group_size:PMKL_INT);_CALLING external {$ifdef libmkl} libmkl{$endif};
